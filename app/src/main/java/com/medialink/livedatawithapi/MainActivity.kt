...
import com.medialink.livedatawithapi.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with(mainViewModel) {
            restaurant.observe(this@MainActivity, { restaurant ->
            ...
            listReview.observe(this@MainActivity, { consumerReviews ->
                val listReview = consumerReviews.map {
                    "${it.review}\n- ${it.name}"
                }
                activityMainBinding.lvReview.adapter =
                    ArrayAdapter(this@MainActivity, R.layout.item_review, listReview)
